...
#ax2.add_patch(rect4)
ax2.axis('off')
plt.savefig(directory+filename.replace('.tif', '/')+filename+'_'+str(n3)+'_heightpatches.jpg', format ='jpg', dpi = 500)
